...
function mouseWheel(b,scroll)
{
    ...
    li.height(h);
    li.width(w);
    li.css("lineHeight",$(window).height()+"px");
  //制作鼠标滚动
    ...
    function fn(ev)
    {
        ...
        if (b)
        {
            if(!box.is(":animated"))
            {
                ...
                else
                {
                    ...
                    iNow--;
                    box.animate({top:box.offset().top+=parseInt($(window).height())}, 800,"easeBoth")
                }
               // tab(iNow);
            }
        ...
        else
        {
            if(!box.is(":animated"))
            {
                console.log(-(box.height()-$(window).height()));//-2280
                console.log(box.offset().top);//-2780
    ...
    $(window).resize(function()
    {
        ...
        li.height(h);
        li.width(w);
        li.css("lineHeight",h+"px");
        box.animate({top:-iNow*parseInt(h)}, 300,"easeBoth");
