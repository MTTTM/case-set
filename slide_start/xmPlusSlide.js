...
(function($){
    $.fn.xmPlus=function(options)
    {
        ...
        return $(this).each(function()
        {
            ...
            var starFun=function(){if($.isFunction( opts. starFun )){opts. starFun(defaultIndex)}};
            init();
            function init()//初始化
            {
            ...
            function toPlay()
            {
                ...
                {
                    case "fade":
                        mainCeil.children().fadeOut(120,endFun);
                        mainCeil.children().eq(defaultIndex).fadeIn(120,endFun);
                        tabClass();
                        pageStates();
                        starFun();
                        break;
                    case "show":
                        mainCeil.children().hide(0,endFun);
                        mainCeil.children().eq(defaultIndex).show(0,endFun);
                        tabClass();
                        pageStates();
                        starFun();
                        break;
                    case "left":
                         mainCeil.animate({"left":-defaultIndex*mainCeil.children().outerWidth(true)*scroll},delayTime,endFun);
                        tabClass();
                        pageStates();
                        starFun();
                        break;
                       ...
                       if(trigger=="mouseover"||trigger=="mouseenter")
                        {
                            tabClass();
                            pageStates();
                            titCeil.eq(defaultIndex).find(targetCeil).stop().slideDown(120,endFun);
                            starFun();
                        }
                        else if(trigger=="mouseout"||trigger=="mouseleave")
                        {

                            titCeil.eq(defaultIndex).find(targetCeil).stop().slideUp(120,endFun);
                    ...
                    case "navSlideFade":
                        if(trigger=="mouseover"||trigger=="mouseenter")
                        {
                            tabClass();
                            pageStates();
                            titCeil.eq(defaultIndex).find(targetCeil).stop().fadeIn(120,endFun);
                            starFun();
                        }
                        else if(trigger=="mouseout"||trigger=="mouseleave")
                        {

                            titCeil.eq(defaultIndex).find(targetCeil).stop().fadeOut(120,endFun);
                            if( returnDefault==true||returnDefault=="true")
                            {
                                plus.mouseleave(function()
                                {
                    ...
                    case "slideMenu":
                        ...
                        pageStates();
                        starFun();
                        targetCeil.eq(defaultIndex).slideDown().siblings("ul").slideUp(120,endFun);
                        break;
                }
            }
